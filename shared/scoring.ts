...
export function scoreLocationGuess(guess: Coordinates, answer: Coordinates) {
...
export function scoreRound(guess: Coordinates, answer: Coordinates, isSituationCorrect: boolean) {
